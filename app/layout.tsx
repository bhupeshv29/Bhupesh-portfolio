...
export const metadata: Metadata = {
  ...
  publisher: "Bhupesh Verma",

  openGraph: {
    type: "website",
    locale: "en_US",
    url: SITE_URL,
    siteName: "Bhupesh Verma",
    title:
      "Bhupesh Verma | Full Stack Developer — Backend, AI & Infrastructure",
    description:
    ...
    "@graph": [
      {
        ...
        "@id": `${SITE_URL}/#website`,
        name: "Bhupesh Verma",
        alternateName: "Bhupesh Verma Portfolio",
        url: SITE_URL,
        description:
          "Official portfolio website of Bhupesh Verma, Full Stack Developer specializing in backend systems, infrastructure, and applied AI.",
        publisher: {
          "@id": `${SITE_URL}/#person`,
        },
      },
